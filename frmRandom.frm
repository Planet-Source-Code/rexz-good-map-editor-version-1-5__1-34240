...
For i = 0 To 287
    ...
    frmMain.Tile(i).Picture = frmMain.SelTile(0).Picture
    ...
    frmMain.Tile(i).Picture = frmMain.SelTile(1).Picture
    ...
    frmMain.Tile(i).Picture = frmMain.SelTile(2).Picture
    ...
    frmMain.Tile(i).Picture = frmMain.SelTile(3).Picture
